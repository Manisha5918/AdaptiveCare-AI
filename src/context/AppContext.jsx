...
export const AppProvider = ({ children }) => {
  ...
  // Sync accessibility font scale class globally
  useEffect(() => {
    const scales = ['font-scale-small', 'font-scale-medium', 'font-scale-large', 'font-scale-extra-large'];
    scales.forEach(s => document.documentElement.classList.remove(s));
    
    let scaleClass = 'font-scale-medium';
    switch (fontScale) {
      case 'small': scaleClass = 'font-scale-small'; break;
      case 'large': scaleClass = 'font-scale-large'; break;
      case 'extra-large': scaleClass = 'font-scale-extra-large'; break;
      default: scaleClass = 'font-scale-medium';
    }

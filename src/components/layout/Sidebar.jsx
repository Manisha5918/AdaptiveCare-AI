...
export default function Sidebar() {
  ...
  return (
    <aside className="w-full lg:w-[260px] flex-shrink-0 border-b lg:border-b-0 lg:border-r border-slate-200 dark:border-charcoal-800 bg-white/40 dark:bg-charcoal-950/40 backdrop-blur-md flex flex-col justify-between p-6 z-25 transition-all duration-300">

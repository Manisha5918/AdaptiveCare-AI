...
import { X, Sliders, Eye, EyeOff, LayoutGrid } from 'lucide-react';
                ...
                {allWidgets.map((wid) => {
                  ...
                  return (
                    <div
                      ...
                      className={`flex items-center justify-between p-3 rounded-[16px] cursor-pointer border transition-all duration-200 hover:shadow-sm ${
                        isVisible

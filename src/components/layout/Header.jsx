...
import { Bell, Moon, Sun, Search, Command, Sliders, Settings } from 'lucide-react';
      ...
      <header className="relative flex flex-col md:flex-row md:items-center justify-between gap-4 py-4 px-6 border-b border-slate-200 dark:border-charcoal-800 bg-white/45 dark:bg-charcoal-900/35 backdrop-blur-md z-30 transition-all duration-300">
          ...
          {profileOptions.map(opt => {
            ...
            return (
              <button
                ...
                className={`relative px-4 py-1.5 rounded-[12px] text-xs font-bold transition-all duration-200 flex items-center gap-1.5 whitespace-nowrap ${
                  isSelected 
        ...
        <div className="flex items-center gap-3 self-end md:self-auto">
          ...
          <button
            ...
            className="hidden md:flex items-center gap-1.5 px-3 py-1.5 bg-slate-100 dark:bg-charcoal-950 text-charcoal-400 dark:text-charcoal-500 rounded-xl hover:bg-slate-200 dark:hover:bg-charcoal-900 border border-slate-200/50 dark:border-charcoal-800 transition-colors text-xs font-bold"
          >
            <Command size={12} />
            <span>Search</span>
          ...
          <button
            ...
            className="p-2.5 bg-slate-100 dark:bg-charcoal-950 hover:bg-slate-200 dark:hover:bg-charcoal-900 text-charcoal-500 dark:text-charcoal-400 rounded-xl transition-all border border-slate-200/50 dark:border-charcoal-800"
          >
            <Sliders size={16} />
          </button>
          ...
          <button
            ...
            className="p-2.5 bg-slate-100 dark:bg-charcoal-950 hover:bg-slate-200 dark:hover:bg-charcoal-900 text-charcoal-500 dark:text-charcoal-400 rounded-xl transition-all relative border border-slate-200/50 dark:border-charcoal-800"
          >
            <Bell size={16} />
            {unreadCount > 0 && (

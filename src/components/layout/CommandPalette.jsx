...
import { Search, Command, ShieldAlert, Sparkles, Sliders, Sun, Moon, Check, CornerDownLeft } from 'lucide-react';
...
export default function CommandPalette({ isOpen, onClose, onOpenSettings }) {
  ...
  const allActions = [
    ...
    { id: 'switch-caregiver', title: 'Switch to Family Caregiver mode', subtitle: '🛡️ Patient monitoring and calendar logs', category: 'Profiles', shortcut: 'C', action: () => setCurrentProfileId('caregiver') },
    ...
    { id: 'open-settings', title: 'Open Dashboard Settings', subtitle: '⚙️ Customize active widget nodes', category: 'System', shortcut: ',', action: () => { onClose(); onOpenSettings(); } },
